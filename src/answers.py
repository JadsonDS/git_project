...
def rd1_question_9(df):
    ...
    fig.update_traces(textfont_size=14, textangle=1, textposition="outside", cliponaxis=False, textfont_color='black')
...
def rd2_question_1(df):
    ...
    fig.update_traces(textfont_size=13,texttemplate="$ %{text:.2f}", textangle=1, textposition="outside", cliponaxis=False, textfont_color='black')
...
def rd2_question_3(df):
    ...
    fig.update_traces(textfont_size=10, texttemplate="$ %{text:.0f} Years", textangle=1, textposition="inside", cliponaxis=False, textfont_color='black')
...
def rd2_question_7(df):
    ...
    fig.update_traces(textfont_size=13, textangle=1, textposition="outside", cliponaxis=False, textfont_color='black')
...
def rd3_question_2(df):
    ...
    fig.update_traces(textfont_size=15, texttemplate="$ %{text:.2f}", textposition="outside", textfont_color='black')
...
def rd3_question_5(df):
    ...
    fig.update_traces(marker={"size": 20}, textposition="top center", textfont_color='black')
...
def rd3_question_7(df):
    ...
    # Columns
    columns = ["id", "name", "selling_price", "km_driven", "year", 'age', 'km_class', 'km_per_year', 'owner', 'company']
    ...
    st.dataframe(df_selected, height=500)
